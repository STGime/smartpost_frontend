            ...
            <div class="card">
              <div class="card-header">
                <div>
                  ...
                  <div class="card-title">1 asset → 9 posts scheduled</div>
                </div>
        ...
        <section class="section" id="platforms">
          ...
          <div class="platform-grid">
            ...
            <div class="platform-card">
              ...
              <div class="platform-formats">
                <div class="format-item"><span class="format-label">Single</span><span class="format-size">1200×675</span></div>
                <div class="format-item"><span class="format-label">Card</span><span class="format-size">1200×628</span></div>
